...
public class ControlPanel extends JPanel implements SimulatorObserver{
	...
	private void initGUI() {
		...
		//Boton adicional examen (borrar un cuerpo)
		createDeleteButton(toolBar1);
		toolBar1.addSeparator();
		//
	...
	private void createLoadButton(JToolBar toolBar) {
		...
		loadButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JFileChooser fileChooser = new JFileChooser("C:\\hlocal\\workspace-4.7-64bits\\Practica5\\resources\\examples");
	...
	private void createDeleteButton(JToolBar toolbar) {
		deleteButton = new JButton();
		
		deleteButton.setToolTipText("Remove a body from the simulator");
		deleteButton.setIcon(new ImageIcon("icons/exam.png"));
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Object[] options = new Object[_ctrl.getNumBodies()];
				int i = 0;
				
				for(String str : _ctrl.getBodiesInfo()) {
					options[i] = str;
					i++;
				}
				
				String n = (String) JOptionPane.showInputDialog(null,
						"Select body to remove.",
						"Bodye Remove Selector",
						JOptionPane.INFORMATION_MESSAGE, null, options, null);
